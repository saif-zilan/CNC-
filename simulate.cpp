...
int main() {
    ...
    // Example simulation logic: set forces and simulate motion
    for (int i = 0; i < 10; ++i) {
        // Set forces for each axis (replace with your actual simulation logic)
        xAxis.setForce(1.0);
        yAxis.setForce(0.8);
        zAxis.setForce(0.5);
        ...
        // Display current positions (replace with your actual simulation logic)
        std::cout << "X Position: " << xAxis.getPosition() << ", ";
        std::cout << "Y Position: " << yAxis.getPosition() << ", ";
        std::cout << "Z Position: " << zAxis.getPosition() << std::endl;

        // Pause for visualization (replace with your actual simulation logic)
